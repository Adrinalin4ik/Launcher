...
namespace Launcher_FTP
{
    public interface IFtpClient
    {
        ...
        void DownloadFile(string path, string fileName, string saveToPath);
        ...
        class FtpClient:IFtpClient
        {
            ...
            public void DownloadFile(string path, string fileName,string saveToPath)
            {
                ...
                FileStream downloadedFile = new FileStream(saveToPath+"/", FileMode.Create, FileAccess.ReadWrite);
            ...
            public void DeleteFile(string path)
            {
                try
                {
                    ftpRequest = (FtpWebRequest)WebRequest.Create(new Uri("ftp://" + _Host + path));
                    ftpRequest.Credentials = new NetworkCredential(_UserName, _Password);
                    ftpRequest.EnableSsl = _UseSSL;
